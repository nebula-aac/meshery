...
import { findWorkloadByName } from "./workflowFilter";
...
export function isEmptyObj(obj: Object): boolean {
    return !obj || obj && Object.keys(obj).length === 0 && Object.getPrototypeOf(obj) === Object.prototype
}
 ...
 */
export function isEmptyArr(arr: Array<string>) {
 ...
 */
export function isEqualArr(arr1: Array<any>, arr2: Array<any>, orderMatters: boolean = true) {
