...
func processCytoElementsWithPattern(eels []cytoscapejs.Element, pf *Pattern, callback func(svc Service, ele cytoscapejs.Element) error) error {
	for _, elem := range eels {
